...
public class AVLTreeStructureTest {
    ...
    public static void main(String[] args) {
        ...
        int[] AVLAfterRemoval = new int[]{19, 15, 30, 13, 25, 41};  // Calculate by hand
        ISortedMap<Integer, Integer> m3 = new BinarySearchTreeMap<>();

        for (int v : AVLAfterRemoval)
            m3.put(v, v);

        IBinaryTree<IEntry<Integer, Integer>> t3 = (IBinaryTree<IEntry<Integer, Integer>>) m1;
        IBinaryTree<IEntry<Integer, Integer>> t4 = (IBinaryTree<IEntry<Integer, Integer>>) m3;

        System.out.println("AVL Tree after removing 1, 31, 28, 54, 32, 77:");
        TreePrinter.printTree(t3);
        System.out.println("Is the AVL Tree in the expected shape after removals? " + (areEqual(t3, t3.root(), t4, t4.root()) ? "YES! :-D" : "No! :-("));
